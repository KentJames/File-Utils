 ...
 *      FILE:     hashtest.c
 *
 *      CONTENTS: C implementation of RIPEMD-160
 *                
 ...
 *
 *      ORIGINAL AUTHOR:   Antoon Bosselaers, ESAT-COSIC
 *      MODIFIED BY: James Kent for use by python.
 *      DATE:     14th October 2012
 *     
 *      Reccommended Compiler: GCC
 *      Reccommended Options:  gcc -Wall -Wstrict-prototypes -I/usr/include/python3.2 ripemd-160.c hashripemd.c -o hashripemd
 *
 *
